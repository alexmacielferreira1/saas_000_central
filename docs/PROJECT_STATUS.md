...
Verificado em 2026-09-26T01:31:16.034551+00:00.
...
| frontend_functional_validation | blocked | Autenticação, sessão, logout, catálogo/detalhe de SaaS e administradores já possuem integração nativa. As 15 rotas e suas dependências estão classificadas em FRONTEND_ROUTE_JOURNEY_INVENTORY.md. A suíte frontend tem 27 testes em 8 arquivos e 11,21% de cobertura de linhas. Paridade continua bloqueada pelas jornadas Base44, rotas sem teste de renderização e evidências visuais pendentes. |
